...
<html class="no-js">
    ...
    <div class="container" id="jar">
        <div style="text-align: center">
            <img src="{{ asset('/admin/img/bmt.PNG') }}" alt="bmt.png">
        </div>
        <div style="text-align: center; margin-top: 2em">
            <label>Amazon Station DRI1</label>
        </div>
        <div style="text-align: center">
            <label>115 Dupont Dr</label>
        </div>
        <div style="text-align: center">
            <label>Providence RI 02907</label>
        </div>
        <form id="send_hire">
            <div class="comment-row content" style="margin-top: 2em">
                <div class="col-lg-12 mb-5">
                    <div class="col-lg-2 mb-3">
                        <label for="date">Date: {{ $doc_docusign->doc_date ?? '' }}</label>
                    </div>
                    <div class="col-lg-4 mb-3">
                        <label for="name">Name: {{ $doc_docusign->doc_name ?? '' }}</label>
                    </div>
                    <div class="col-lg-4 mb-3">
                        <label for="address">Address: {{ $doc_docusign->doc_address ?? '' }}</label>
                    </div>
                    <div class="col-lg-4 mb-5">
                        <label for="city">City, State and Zip Code: {{ $doc_docusign->doc_city ?? '' }}, {{ $doc_docusign->doc_state ?? '' }} and {{ $doc_docusign->doc_zip ?? '' }}</label>
                    </div>
                </div>
                ...
                <div class="col-lg-12 mb-5">
                    ...
                    <div class="col-lg-12 mb-3">
                        <span>Dear {{ $doc_docusign->doc_name ?? '' }}</span>          
                        ...
                        <div class="container">
                            <p style="text-align: justify">1. Verification of your right to work in the United States, as shown by your completion
                            ...
                            first day of work.</p>
                            <p style="text-align: justify">2. Verification that you are at least 21 years of age and have a valid driver’s license of the type required to operate the applicable motor vehicle.</p>
                            <p style="text-align: justify">3. Satisfactory completion of a background check.</p>
                            <p style="text-align: justify">4. Satisfactory completion of a motor vehicle/driving record check.</p>
                            <p style="text-align: justify">5. Satisfactory completion of a five-panel drug test.
                        </div>
                        <p style="text-align: justify">
                        ...
                        employment:</p>
                        <div class="container">
                            <p style="text-align: justify">1. Confidentiality and Non-Disclosure Agreement</p>
                            <p style="text-align: justify">2. Authorization and Consent for Shared Information</p>
                        </div>
                        <p style="text-align: justify">
                        ...
                        <p style="text-align: justify">This offer will be withdrawn if any of the above conditions are not satisfied. Please do not resign
                        from your current job until you have confirmation from the Company that these conditions have
                        been satisfied.</p>
                        <p style="text-align: justify">This letter is merely a summary of the principal terms of our employment offer and is not a contract
                        ...
                        <p style="text-align: justify">This offer will be held open for five (5) business days. Upon expiration of that period, it will be
                        deemed to be withdrawn.</p>
                        <p style="text-align: justify">We are excited at the prospect of you joining our team. If you are in agreement with the above
                        ...
                        <div>
                            <div>
                                <label>Signature: {{ $doc_docusign->doc_name ?? '' }}</label>
                            </div>
                            <div>
                                <label>Date: {{ $doc_docusign->doc_date ?? '' }}</label>
                            </div>
                            <div>
                                <label>Printed Name: {{ $doc_docusign->doc_name ?? '' }}</label>
                            </div>
                        </div>
            ...
            <div class="comment-row content">
                <div class="col-lg-12 mb-5">
                    ...
                    <div class="col-lg-12 mb-5 div_border">
                        <div class="col-lg-4 mb-5 mt-5">
                            ...
                            <div class="bottom_border"><p style="text-align: justify"><b>1. </b>U.S. Passport or U.S. Passport Card</p></div>
                            <div class="bottom_border"><p style="text-align: justify"><b>2. </b>Permanent Resident Card or Alien Registration Receipt Card (Form I-551)</p></div>
                            <div class="bottom_border"><p style="text-align: justify"><b>3. </b>Foreign passport that contains a temporary I-551 stamp or temporary I-551 printed notation on a machinereadable immigrant visa</p></div>
                            <div class="bottom_border"><p style="text-align: justify"><b>4. </b>Employment Authorization Document that contains a photograph (Form I-766)</p></div>
                            <div class="bottom_border">
                                <p style="text-align: justify"><b>5. </b>For a nonimmigrant alien authorized to work for a specific employer because of his or her status:</p>
                                <p style="text-align: justify"><b>a. </b>Foreign passport; and</p>
                                <p style="text-align: justify"><b>b. </b>Form I-94 or Form I-94A that has the following:</p>
                                <p style="text-align: justify">(1) The same name as the passport; and</p>
                                <p style="text-align: justify">(2) An endorsement of the alien's nonimmigrant status as long as that period of endorsement has not yet expired and the proposed employment is not in conflict with any restrictions or limitations identified on the form</p>
                            </div>
                            <div>
                ...
                <div class="col-lg-12 mb-5">
                    ...
                    <div class="col-lg-12 mb-3">
                        <input type="radio" id="free_copy_yes" name="report_free_copy" value="free_copy_yes" {{ ($doc_docusign->consumer_copy_free=="1")? "checked" : "" }}> Yes
                        <input type="radio" id="free_copy_no" name="report_free_copy" value="free_copy_no" {{ ($doc_docusign->consumer_copy_free=="0")? "checked" : "" }}> No
                    </div>
            ...
            <div class="comment-row content">
                <div class="col-lg-12 mb-5">
                    ...
                    <div class="col-lg-12 mb-5">
                        <div class="row mb-3">
                            <div class="form-group col-lg-3">
                                <label>Print Name: {{ $doc_docusign->doc_name ?? '' }}</label>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="form-group col-lg-3">
                                <label for="other_name">Other Names Known By: {{ $doc_docusign->doc_other_name ?? '' }}</label>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="form-group col-lg-6">
                                <label for="social_num">Social Security Number: {{ $doc_docusign->SSN ?? '' }}</label>
                            </div>
                            <div class="form-group col-lg-4">
                                <label for="birth">Date of Birth: {{ $doc_docusign->doc_birth ?? '' }}</label>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="form-group col-lg-6">
                                <label for="license_num">Driver’s License Number: {{ $doc_docusign->DLN ?? '' }}</label>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="form-group col-lg-3">
                                <label>Current Address: {{ $doc_docusign->doc_state ?? '' }}, {{ $doc_docusign->doc_city ?? '' }}</label>
                            </div>
                            <div class="form-group col-lg-3">
                                <label>City: {{ $doc_docusign->doc_city ?? '' }}</label>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="form-group col-lg-3">
                                <label>State: {{ $doc_docusign->doc_state ?? '' }}</label>
                            </div>
                            <div class="form-group col-lg-3">
                                <label>Zip: {{ $doc_docusign->doc_zip ?? '' }}</label>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="form-group col-lg-3 mb-3">
                                <label>Applicant Signature: {{ $doc_docusign->doc_name ?? '' }}</label>
                            </div>
                            <div class="form-group col-lg-3 mb-3">
                                <label>Date: {{ $doc_docusign->doc_date ?? '' }}</label>
                            </div>
            ...
            <div class="comment-row content">
                <div class="col-lg-12">
                    ...
                    <div class="col-lg-12 mb-5">
                        ...
                        <div class="row mb-3">
                            <div class="form-group col-lg-3">
                                <label>Employee Signature: {{ $doc_docusign->doc_name ?? '' }}</label>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-5 col-lg-12">
                    ...
                    <div class="mb-3 col-lg-12">
                        <div class="col-lg-12 mb-3">
                            ...
                            <div class="form-group col-lg-4">
                                <label for="applied_pos">Position(s) Applied For: {{ $doc_docusign->applied_pos ?? '' }}</label>
                            </div>
                            <div class="form-group col-lg-4">
                                <label>Name: {{ $doc_docusign->doc_name ?? '' }}</label>
                            </div>
                        </div> 
                        
                        <div class="col-lg-12 mb-3">
                            <div class="form-group col-lg-6">
                                <label>Address: {{ $doc_docusign->doc_name ?? '' }}</label>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 mb-3">
                            <div class="form-group col-lg-4">
                                <label for="telephone_num">Telephone: {{ $doc_docusign->doc_tele ?? '' }}</label>
                            </div>
                            <div class="form-group col-lg-4">
                                <label for="cellphone_num">Cell phone: {{ $doc_docusign->doc_cell ?? '' }}</label>
                            </div>
                        </div> 

                        <div class="col-lg-12 mb-3">
                            <div class="col-lg-9">
                                <label for="email_address">Email Address: {{ $doc_docusign->doc_email ?? '' }}</label>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 mb-3">
                            <div class="col-lg-12">
                                ...
                                <label>{{ $doc_docusign->hear_info ?? '' }}</label>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 mb-3">
                            ...
                            <div class="col-lg-12">
                                <input type="radio" id="legal_yes" name="legal_yeno" value="legal_auth_yes" {{ ($doc_docusign->legal_auth_state=="1")? "checked" : "" }}> Yes
                                <input type="radio" id="legal_no" name="legal_yeno" value="legal_auth_no" {{ ($doc_docusign->legal_auth_state=="0")? "checked" : "" }}> No
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 mb-3">
                            ...
                            <div class="col-lg-12">
                                <input type="radio" name="sponsor_yeno" value="sponsorship_yes" {{ ($doc_docusign->require_sponsorship=="1")? "checked" : "" }}> Yes
                                <input type="radio" name="sponsor_yeno" value="sponsorship_no" {{ ($doc_docusign->require_sponsorship=="0")? "checked" : "" }}> No
                            </div>
                            <div class="col-lg-12">
                        ...
                        <div class="col-lg-12 mb-3">
                            ...
                            <div class="col-lg-12">
                                <label>{{ $doc_docusign->avail_date ?? '' }}</label>
                            </div>
                        </div>
                        <div class="col-lg-12 mb-3">
                            <label>Type of work sought?</label>
                            <div class="col-lg-12">
                                <input type="radio" id="full" name="full_part_temp" {{ ($doc_docusign->require_sponsorship=="0")? "checked" : "" }}> Full Time
                                <input type="radio" id="part" name="full_part_temp" {{ ($doc_docusign->require_sponsorship=="1")? "checked" : "" }}> Part Time
                                <input type="radio" id="temp" name="full_part_temp" {{ ($doc_docusign->require_sponsorship=="2")? "checked" : "" }}> Temporary
                            </div>
                        </div>
                    </div>
            ...
            <div class="comment-row content">
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                ...
                                <div class="row col-lg-12 mb-3">
                                    ...
                                    <label style="width:25%;text-align:center;">From:</label>
                                    <label style="width:25%;text-align:center;">To:</label>
                                </div>
                                <div class="row col-lg-12 mb-3">
                ...
                <div class="mb-5 col-lg-12">
                    ...
                    <table class="responsive-table-input-matrix">
                        ...
                        <tr>
                            <td>School Name</td>
                            <td>{{ $doc_education->high_name ?? '' }}</td>
                            <td>{{ $doc_education->col_name ?? '' }}</td>
                            <td>{{ $doc_education->grad_name ?? '' }}</td>
                        </tr>
                        <tr>
                            <td>City, State, Country</td>
                            <td>{{ $doc_education->high_CSC ?? '' }}</td>
                            <td>{{ $doc_education->col_CSC ?? '' }}</td>
                            <td>{{ $doc_education->grad_CSC ?? '' }}</td>
                        </tr>
                        <tr>
                            <td>Years Completed</td>
                            <td>{{ $doc_education->high_year ?? '' }}</td>
                            <td>{{ $doc_education->col_year ?? '' }}</td>
                            <td>{{ $doc_education->grad_year ?? '' }}</td>
                        </tr>
                        <tr>
                            <td>Diploma/Degree</td>
                            <td>{{ $doc_education->high_degree ?? '' }}</td>
                            <td>{{ $doc_education->col_degree ?? '' }}</td>
                            <td>{{ $doc_education->grad_degree ?? '' }}</td>
                        </tr>
                        <tr>
                            <td>Describe Course of Study</td>
                            <td>{{ $doc_education->high_study ?? '' }}</td>
                            <td>{{ $doc_education->col_study ?? '' }}</td>
                            <td>{{ $doc_education->grad_study ?? '' }}</td>
                        </tr>
                        <tr>
                            ...
                            Activities</td>
                            <td>{{ $doc_education->high_spec ?? '' }}</td>
                            <td>{{ $doc_education->col_spec ?? '' }}</td>
                            <td>{{ $doc_education->grad_spec ?? '' }}</td>
                        </tr>
                        </tbody>
                    </table>
                    </div>
                ...
                <div class="col-lg-12 mb-5">
                    ...
                    <div style="text-align:center;">
                        <div class="form-group col-lg-12">
                            <p>{{ $doc_certification->certi_info1 ?? '' }}</p>
                    ...
                    <div style="text-align:center;">
                        <div class="form-group col-lg-12">
                            <p>{{ $doc_certification->certi_info2 ?? '' }}</p>
                            <p>(Please initial here to indicate that you have read and understand the above paragraph.)</p>
                        </div>
                    </div>
                    ...
                    <div style="text-align:center;">
                        <div class="form-group col-lg-12">
                            <p>{{ $doc_certification->certi_info3 ?? '' }}</p>
                            <p>(Please initial here to indicate that you have read and understand the above paragraph.)</p>
                        </div>
                    </div>
                    ...
                    <div class="row mb-5 col-lg-12">
                        ...
                        <div class="form-group col-lg-3">
                            <label>Name (please print): {{ $doc_docusign->doc_name ?? '' }}</label>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12 mb-5">
                    ...
                    <div class="col-lg-12">
                        <h4 style="text-decoration-line:underline;"><b>Step 1: Enter Personal Information</b></h4>
                            ...
                            <div class="row col-lg-12 mb-3">
                                <div class="col-lg-4">
                                    <label for="first_name">First name and middle initial {{ $doc_docusign->doc_first_name ?? '' }}</label>
                                </div>
                                <div class="col-lg-4">
                                    <label for="last_name">Last name {{ $doc_docusign->doc_last_name ?? '' }}</label>
                                </div>
                            </div>

                            <div class="row col-lg-12 mb-3">
                                <div class="col-lg-6">
                                    <label>Social security number {{ $doc_docusign->SSN ?? '' }}</label>
                                </div>

                                <div class="col-lg-6">
                                    <label>Address {{ $doc_docusign->doc_address ?? '' }}</label>
                                </div>
                            </div>
                            
                            <div class="row col-lg-12 mb-3">
                                <div class="col-lg-3">
                                    <label>City or town {{ $doc_docusign->doc_city ?? '' }}</label>
                                </div>
                                <div class="col-lg-3">
                                    <label>State {{ $doc_docusign->doc_state ?? '' }}</label>
                                </div>
                                <div class="col-lg-3">
                                    <label>ZIP code {{ $doc_docusign->doc_zip ?? '' }}</label>
                                </div>
                            </div>
                            ...
                            <div class="row col-lg-12 mb-3">
                                <fieldset>
                                    <div>
                                        <label>Single or Married filing separately {{ $doc_docusign->doc_zmarried_sepip ?? '' }}</label>
                                    </div>
                                    <div>
                                        <label>Married filing jointly {{ $doc_docusign->married_join ?? '' }}</label>
                                    </div>
                                    <div>
                                        <label>Head of household {{ $doc_docusign->married_head ?? '' }}</label>
                                    </div>
                                </fieldset>
                            </div>
                            <div class="row col-lg-12 mb-3">
